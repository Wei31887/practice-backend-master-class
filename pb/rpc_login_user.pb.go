...
type LoginUserResponse struct {
	...
	AccessExpiredAt  *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=access_expired_at,json=accessExpiredAt,proto3" json:"access_expired_at,omitempty"`
	RefreshExpiredAt *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=refresh_expired_at,json=refreshExpiredAt,proto3" json:"refresh_expired_at,omitempty"`
}
...
func (x *LoginUserResponse) GetAccessExpiredAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *LoginUserResponse) GetRefreshExpiredAt() *timestamppb.Timestamp {
	if x != nil {
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x64, 0x22, 0xaa, 0x02, 0x0a, 0x11, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x55, 0x73, 0x65,
	...
	0x69, 0x72, 0x65, 0x64, 0x41, 0x74, 0x12, 0x48, 0x0a, 0x12, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73,
	...
	0x42, 0x14, 0x5a, 0x12, 0x6c, 0x65, 0x73, 0x73, 0x6f, 0x6e, 0x2f, 0x73, 0x69, 0x6d, 0x70, 0x6c,
...
var file_rpc_login_user_proto_depIdxs = []int32{
	...
	3, // 1: pb.LoginUserResponse.access_expired_at:type_name -> google.protobuf.Timestamp
	3, // 2: pb.LoginUserResponse.refresh_expired_at:type_name -> google.protobuf.Timestamp
